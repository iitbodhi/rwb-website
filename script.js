...
function initNav(){
    ...
    document.addEventListener('click',(e)=>{
        ...
        /* Don't close if clicking inside drawer or on toggle */
        if(right.contains(e.target)||toggle.contains(e.target))return;
        closeNav();
    },true); /* useCapture=true so it fires even when scrolled */
