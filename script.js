...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initBadgeMusic();
    initLightbox();
    /* Safety: reveal hero after 1.6s regardless of preloader state */
...
function initPreloader() {
    ...
    /* Hard cap: always dismiss within 1.5s no matter what */
    const timer = setTimeout(hide, 1500);
    /* Dismiss as soon as all resources are loaded */
    window.addEventListener('load', () => { clearTimeout(timer); setTimeout(hide, 100); }, { once: true });
}
